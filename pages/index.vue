<template>
    <div class="flex h-full">
        <Sidebar class="w-1/3 max-w-md h-full"></Sidebar>
        <Room v-if="currentRoom" class="flex-grow"></Room>
        <div v-else class="flex-grow flex justify-center items-center bg-pattern">
            <b class="text-4xl text-gray-lighter">Start a conversation</b>
        </div>
    </div>
</template>
